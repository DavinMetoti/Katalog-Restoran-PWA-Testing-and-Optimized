...
<article tabindex="0" class="resto-item">
  ...
  restaurant.city
}</p><p class="resto-item_rating" 
aria-label="rating resto ${restaurant.rating}">⭐️ ${
  restaurant.rating
}</p>
      ...
      (review) => `
          <div class="detail-review-item">
            <div class="header-review">
              <i title="restaurant" class="fa fa-user-circle" style="font-size:2em; padding-right:10px;"></i>
